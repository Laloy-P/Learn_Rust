...
@alloc28 = private unnamed_addr constant <{ [100 x i8] }> <{ [100 x i8] c"/Users/pierre/.rustup/toolchains/stable-x86_64-apple-darwin/lib/rustlib/src/rust/src/liballoc/vec.rs" }>, align 1
@alloc29 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [100 x i8] }>, <{ [100 x i8] }>* @alloc28, i32 0, i32 0, i32 0), [16 x i8] c"d\00\00\00\00\00\00\00N\09\00\00%\00\00\00" }>, align 8
